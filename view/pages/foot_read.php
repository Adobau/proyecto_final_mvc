...
<footer id="footer" class="page-footer naranja-ast">
      ...
      <div class="row">
        ...
        <div class="col l3 s12">
          ...
          <li><a class="white-text" href="mailto:brayannolasco011@gmail.com">Cristian  Vladimir Orellana Orellana</a></li>
            ...
            <li><a class="white-text" target="_blank">Douglas Josue Ayala Cordóva</a></li>
          </ul>
        </div>
    ...
    <div class="footer-copyright gris-ast">
      <div class="container">
      by <a class="white-text"  target="_blank"> Adonis Alejandro Marín Bautista| Tecnico en Ingenieria en Sistema.</a>
      </div>
    </div>
  </footer>
