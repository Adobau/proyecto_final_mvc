                ...
                <table id="tabla-activos" class="striped responsive-table highlight">
                  ...
                  <!-- inicio del cuerpo de la tabla activos -->
                      <tr>
                          ...
                          <td>Color</td>
                          <td class="center">
                              <a href="?c=<?php echo base64_encode('Color'); ?>&idcolor=<?php echo base64_encode('idcolor'); ?>" title="Editar Registro" ><i class="mini material-icons azul-ast-text hoverable circle ">edit</i></a>
                          </td>
                          <td class="center">
                              <a onclick="javascript:return confirm('¿Seguro que desea desactivar este registro?');" href="?c=<?php echo base64_encode('Color'); ?>&a=<?php echo base64_encode('CambiarEstado'); ?>&nuevo_estado=<?php echo base64_encode('0'); ?>&idcolor=<?php echo base64_encode('idcolor'); ?>" title="Desactivar Registro" ><i class="material-icons red-text hoverable circle mini">cancel</i></a>
                          </td>
                      </tr>
                      <tr>
                          <td>Idcolor</td>
                ...
                <table id="tabla-inactivos" class="striped responsive-table highlight">
                  ...
                  <!-- inicio del cuerpo de la tabla inactivos -->
                      <tr>
                          ...
                          <td>Color</td>
                          <td class="center">
                              <a onclick="javascript:return confirm('¿Seguro que desea activar este registro?');" href="?c=<?php echo base64_encode('Color'); ?>&a=<?php echo base64_encode('CambiarEstado'); ?>&nuevo_estado=<?php echo base64_encode('1'); ?>&idcolor=<?php echo base64_encode('idcolor'); ?>" title="Activar Registro"><i class="mini material-icons green-text hoverable circle">check_circle</i></a>
                          </td>
                      </tr>
                      <tr>
                          <td>Idcolor</td>
